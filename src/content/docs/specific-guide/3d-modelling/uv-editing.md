...
![The UV Editor button in the LoLMaya shelf](/user-pictures/gatrix/uveditorbutton.png)
...
![Texture tab in the Attribute Editor showing the Transparency setting](/user-pictures/gatrix/transparentfix.png)
...
![UV faces outside the 0-1 box on the repeating texture](/user-pictures/gatrix/outsideuvsexample.png)
