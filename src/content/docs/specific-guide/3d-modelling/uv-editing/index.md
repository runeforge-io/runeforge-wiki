...
![The UV Editor button in the LoLMaya shelf](./uveditorbutton.png)
...
![Dragging an image file into the Hypershade Textures tab](./hypershadeimport.png)
...
![Example of a mesh with unwanted transparency](./transparentexample.png)
...
![Texture tab in the Attribute Editor showing the Transparency setting](./transparentfix.png)
...
![UV faces outside the 0-1 box on the repeating texture](./outsideuvsexample.png)
