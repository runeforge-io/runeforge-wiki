---
title: Reducing model attributes
...
![Maya error about exceeding the vertex limit on export](./screenshot_2025-07-19_223221.png)

![Maya error about exceeding the joint limit on export](./screenshot_2025-07-19_223040.png)

## Required tools

- [Autodesk Maya](/core-guides/tools/maya)

## Reduce max verticles

### Solution #1: reduce mesh
...
![The model in the Maya viewport before editing](./screenshot_2025-07-19_230127.png)
...
![The vertex heads-up display showing 65k total and 21k selected](./screenshot_2025-07-19_230324.png)
...
![The Mesh dropdown in the Modeling menu set](./screenshot_2025-07-19_230949.png)
...
![The Reduce Options window](./screenshot_2025-07-19_231838.png)

To simplify this process, i will only explain the 3 settting, shape and reduction method sections:

- setting: decides whether you want to keep the original mesh along with the reduced one together in maya scene or not
- reduction method:
  - vertex limit: decrease my 21k to an x value
  - percentage: decrease my 21k down by x% value
  - triangle limit: idk dont use this one
- shape: it's best to leave default setting, or let it both be 1/1. If you want to read more, refer to [Maya Help | Reduce Options | Autodesk](https://help.autodesk.com/view/MAYAUL/2023/ENU/?guid=GUID-49F4731D-4F59-4B98-9751-F0E1CAA675CD)
...
![The model after reducing the selected mesh](./screenshot_2025-07-19_232651.png)
...
![Face selection mode showing the mesh wireframe](./screenshot_2025-07-19_234006.png)
...
![Selecting flower mesh parts to delete](./screenshot_2025-07-19_234158.png)

![The model after deleting the unnecessary mesh parts](./screenshot_2025-07-19_235528.png)
...
![Assigning a new lambert material to the selected parts](./screenshot_2025-07-19_235801.png)

Start a new scene and import the file you just edit, with this settings perhap.

![Import settings for the exported skn file](./screenshot_2025-07-20_002521.png)

![The reimported model in a new scene](./screenshot_2025-07-20_002601.png)
...
![Selecting the lambert2 mesh and its joint hierarchy to unbind](./screenshot_2025-07-20_005008.png)
