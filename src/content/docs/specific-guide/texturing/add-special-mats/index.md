...
![Lambert material with a base color node in Maya](./mats1.webp)
...
![StaticMaterialDef code of Winterblessed Warwick's crystal material](./mats2.webp)
...
![Example of fresnel and screenspace texture effects](./mats3.webp)
...
![Winterblessed Warwick Prestige Edition's crystal tail material](./mats4.webp)
...
![Ahri's and Warwick's converted bins open in Visual Studio Code](./mats5.webp)
...
![Copying the bodydiamond MaterialOverride into Ahri's bin](./mats6.webp)

If you’d like, you can rename `bodydiamond` to anything you would like. In this instance, I have named it `ahri_mat`.

![MaterialOverride renamed to ahri_mat in the bin](./mats7.webp)
...
![Warwick's StaticMaterialDef pasted into Ahri's bin with her diffuse texture](./mats8.webp)
...
![Mask texture filled entirely with green for the body](./mats9.webp)
...
![Detaching all selected vertices of the model in Maya](./mats10.webp)
...
![Model showing hard edges across every polygon](./mats11.webp)
...
![Final in-game result of the diamond material on Ahri](./mats12.webp)
## Sources
