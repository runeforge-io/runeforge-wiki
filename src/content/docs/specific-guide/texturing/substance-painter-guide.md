...
<img src="/user-pictures/vector/general-guides/substance-guides/reversenormals.webp" alt="Maya menu showing the reverse normals option" height="1200" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/matsgraves.webp" alt="Graves model with a single material assigned" height="1000" />
...
![Substance Painter interface with Texture Set List and Layers panels](/user-pictures/vector/general-guides/substance-guides/modelp1.webp)
...
![Comparison of correctly displayed faces versus flipped faces](/user-pictures/vector/general-guides/substance-guides/modelp2.webp)
...
![Viewport display mode changed from Material to Base Color](/user-pictures/vector/general-guides/substance-guides/modelp3.webp)
...
![Fill layer created with only the color channel enabled](/user-pictures/vector/general-guides/substance-guides/modelp4.webp)
...
<img src="/user-pictures/vector/general-guides/substance-guides/modelp5.webp" alt="Bake Mesh Maps dialog with Ambient Occlusion settings" height="1500" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/modelp6.webp" alt="AO texture on the fill layer with a gradient filter" height="2000" />
...
![Texture comparison with and without the blur filter](/user-pictures/vector/general-guides/substance-guides/modelp7.webp)
...
<img src="/user-pictures/vector/general-guides/substance-guides/modelp8.webp" alt="Fill layer with a black mask used to paint the dress" height="1000" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/export1.webp" alt="Export Textures dialog with only base color selected" height="2600" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/nvidiaexport.webp" alt="Nvidia Texture Tools DDS export settings dialog" height="1150" />

#### Intel Texture Works Export Settings

![Intel Texture Works DDS export settings dialog](/user-pictures/vector/general-guides/substance-guides/intelexport.webp)
...
![Model with an overly dark Ambient Occlusion bake](/user-pictures/vector/general-guides/substance-guides/bakefix1.webp)
...
![Maya normals set to face and edges softened to fix the bake](/user-pictures/vector/general-guides/substance-guides/bakefix2.webp)
...
![Texture size comparison showing pixelation at low resolutions](/user-pictures/vector/general-guides/substance-guides/tip1.webp)
...
![Graves and Akshan face texture resolution comparison](/user-pictures/vector/general-guides/substance-guides/tip1_2.webp)
...
![Zoe's UV layout and downscaled body texture](/user-pictures/vector/general-guides/substance-guides/tip1_3.webp)
...
<img src="/user-pictures/vector/general-guides/substance-guides/lighting1.webp" alt="Diagram of League's top-down lighting on a champion" height="1000" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/lighting2.webp" alt="Graves against a Rift background in color and grayscale" height="800" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/skin1.webp" alt="Painted skin tone example showing hue shifts in shading" height="800" />
...
![Cast shadows under the nose, neck, and overlapping clothing](/user-pictures/vector/general-guides/substance-guides/shadow1.webp)
...
![Male and female torso lighting comparison](/user-pictures/vector/general-guides/substance-guides/shadow2.webp)
...
<img src="/user-pictures/vector/general-guides/substance-guides/shadow3.webp" alt="Champions with green highlights or desaturated skin tones" height="1000" />
...
<img src="/user-pictures/vector/general-guides/substance-guides/shadow4.webp" alt="Unique purple and blue skin tones on Mundo and Lux" height="500" />
...
![Black and white painting colored with a gradient filter](/user-pictures/vector/general-guides/substance-guides/blackandwhite.webp)
...
![Importing a brush alpha texture to the shelf](/user-pictures/vector/general-guides/substance-guides/brush.webp)
