...
tags:
  ...
  level: intermediate
  subject: [texturing]
  tool: [maya, photoshop, gimp, paint-net]
---

Original Wild Rift textures:

![Original flat Wild Rift textures without shadows](/user-pictures/goat/improvingtextures/1.webp)

My edit:

![Edited textures with baked occlusion shadows applied](/user-pictures/goat/improvingtextures/2.webp)
...
![Arnold menu visible in the Maya toolbar](/user-pictures/goat/improvingtextures/3.webp)
...
![Windows Apps and Features list showing Maya](/user-pictures/goat/improvingtextures/23.webp)

Select Maya and click on “Change”.

![Maya entry selected with the Change button](/user-pictures/goat/improvingtextures/24.webp)

Now you get a Autodesk pop-up. Select the Arnold renderer (which is not installed in your case) and press install.

![Autodesk installer with the Arnold renderer selected](/user-pictures/goat/improvingtextures/25.webp)
</details>
...
![Maya Display menu showing the Face Normals option](/user-pictures/goat/improvingtextures/26.webp)
  
If you don’t see any small green lines poking outside your model, you need to reverse Normals. Go to Mesh Display – Reverse.
  
![Mesh Display menu with the Reverse option](/user-pictures/goat/improvingtextures/27.webp)
</details>
...
![Right-click marking menu with Assign new material](/user-pictures/goat/improvingtextures/4.webp)

Select **“aiAmbientOcclusion”**.

![Material list with aiAmbientOcclusion selected](/user-pictures/goat/improvingtextures/5.webp)
...
![Arnold render preview showing soft contact shadows](/user-pictures/goat/improvingtextures/6.webp)

Next click on **Arnold – Utilities – Render Selection to Texture**.

![Arnold Utilities menu with Render Selection to Texture](/user-pictures/goat/improvingtextures/7.webp)
...
![Render to texture window with resolution and camera samples](/user-pictures/goat/improvingtextures/8.webp)
...
![Photoshop EXR import loading alpha channel as transparency](/user-pictures/goat/improvingtextures/9.webp)

If your file looks something like this means it worked:

![Occlusion map layer loaded on top of the texture](/user-pictures/goat/improvingtextures/10.webp)
...
![Occlusion layer set to Multiply with harsh shadows](/user-pictures/goat/improvingtextures/11.webp)
...
![Clipped Curves adjustment layer lightening the shadows](/user-pictures/goat/improvingtextures/12.webp)
...
![Texture with gray shadows next to the skin color](/user-pictures/goat/improvingtextures/13.webp)
...
![New clipped layer set to Color at lowered opacity](/user-pictures/goat/improvingtextures/14.webp)
...
![Rough skin-color brush strokes over the shadow areas](/user-pictures/goat/improvingtextures/15.webp)![Painted color layer blending into the occlusion map](/user-pictures/goat/improvingtextures/16.webp)

![Comparison of painted versus unpainted shadow color](/user-pictures/goat/improvingtextures/17.webp)
...
![Layer style dialog opened by double-clicking the layer](/user-pictures/goat/improvingtextures/18.webp)
...
![Blend If slider dragged left showing crunchy edges](/user-pictures/goat/improvingtextures/19.webp)
...
![Split Blend If arrows creating a smooth transition](/user-pictures/goat/improvingtextures/20.webp)
...
![Curves adjustment layer with the Medium Contrast preset](/user-pictures/goat/improvingtextures/21.webp)

Another thing you can try is blurring the occlusion map if some shadows appear too harsh using Gaussian Blur.

![Gaussian Blur softening harsh occlusion shadows](/user-pictures/goat/improvingtextures/22.webp)
