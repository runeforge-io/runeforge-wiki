...
![Maya menu showing the reverse normals option](./reversenormals.webp)
...
![Graves model with a single material assigned](./matsgraves.webp)
...
![Substance Painter interface with Texture Set List and Layers panels](./modelp1.webp)
...
![Comparison of correctly displayed faces versus flipped faces](./modelp2.webp)
...
![Viewport display mode changed from Material to Base Color](./modelp3.webp)
...
![Fill layer created with only the color channel enabled](./modelp4.webp)
...
![Bake Mesh Maps dialog with Ambient Occlusion settings](./modelp5.webp)
...
![AO texture on the fill layer with a gradient filter](./modelp6.webp)
...
![Texture comparison with and without the blur filter](./modelp7.webp)
...
![Fill layer with a black mask used to paint the dress](./modelp8.webp)
...
![Export Textures dialog with only base color selected](./export1.webp)
...
![Nvidia Texture Tools DDS export settings dialog](./nvidiaexport.webp)

#### Intel Texture Works Export Settings

![Intel Texture Works DDS export settings dialog](./intelexport.webp)
...
![Model with an overly dark Ambient Occlusion bake](./bakefix1.webp)
...
![Maya normals set to face and edges softened to fix the bake](./bakefix2.webp)
...
![Import resources dialog with file type set to texture](./texturefix1.webp)
...
![Texture size comparison showing pixelation at low resolutions](./tip1.webp)
...
![Graves and Akshan face texture resolution comparison](./tip1_2.webp)
...
![Zoe's UV layout and downscaled body texture](./tip1_3.webp)
...
![Diagram of League](./lighting1.webp)
...
![Graves against a Rift background in color and grayscale](./lighting2.webp)
...
![Painted skin tone example showing hue shifts in shading](./skin1.webp)
...
![Cast shadows under the nose, neck, and overlapping clothing](./shadow1.webp)
...
![Male and female torso lighting comparison](./shadow2.webp)
...
![Champions with green highlights or desaturated skin tones](./shadow3.webp)
...
![Unique purple and blue skin tones on Mundo and Lux](./shadow4.webp)
...
![Black and white painting colored with a gradient filter](./blackandwhite.webp)
...
![Importing a brush alpha texture to the shelf](./brush.webp)
