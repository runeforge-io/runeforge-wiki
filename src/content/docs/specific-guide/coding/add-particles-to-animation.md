...
![Bin section that comes right before the paste location](/user-pictures/vector/general-guides/particle-animation/ptcl1.webp)
after that ^
...
and before this v
![Bin section that should come after the pasted container](/user-pictures/vector/general-guides/particle-animation/ptcl2.webp)

---

#### New Champion with VFX in skin0 bin

![The very last particle container in the skin0 bin](/user-pictures/vector/general-guides/particle-animation/ptcl3.webp)
...
and before this v
![Closing brackets that follow the pasted particle system](/user-pictures/vector/general-guides/particle-animation/ptcl4.webp)

**After you’ve pasted**, Delete the 2nd and 3rd bracket at the end so there’s only one. It should look like:
![Pasted system ending with a single closing bracket](/user-pictures/vector/general-guides/particle-animation/ptcl5.webp)

---
After pasting your particle system, make sure to check that there are no double brackets at the beginning and end.

![Checking for double brackets around the pasted particle system](/user-pictures/vector/general-guides/particle-animation/ptcl6.webp)
...
![Renaming the VFX system to GravesRecall_VFX in quotes](/user-pictures/vector/general-guides/particle-animation/ptcl7.webp)
...
![ParticleName and ParticleString renamed to match the system name](/user-pictures/vector/general-guides/particle-animation/ptcl8.webp)
...
![ResourceResolver entry linking the new VFX system name](/user-pictures/vector/general-guides/particle-animation/ptcl9.webp)
...
![Searching the animation bin for the recall .anm file](/user-pictures/vector/general-guides/particle-animation/ptcl10.webp)
...
![mEventDataMap code pasted under the recall animation clip](/user-pictures/vector/general-guides/particle-animation/ptcl11.webp)
...
![Particle event data added to an existing mEventDataMap](/user-pictures/vector/general-guides/particle-animation/ptcl12.webp)
...
![Particle event with mStartFrame set to a later frame](/user-pictures/vector/general-guides/particle-animation/ptcl13.webp)
...
![Particle event using the mIsLoop and mIsKillEvent options](/user-pictures/vector/general-guides/particle-animation/ptcl14.webp)
...
![Ahri's hidden recall submeshes shown via animation events](/user-pictures/vector/general-guides/particle-animation/ptcl15.webp)

Here I’m adding a recall material for Katarina’s recall animation.

![Adding a recall material event for Katarina's recall animation](/user-pictures/vector/general-guides/particle-animation/ptcl16.webp)
## Sources
