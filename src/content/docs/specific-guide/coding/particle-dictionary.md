...
![A VfxSystemDefinitionData container in a bin file](/user-pictures/vector/general-guides/vfxdictionary/vfxsystemdefinitiondata.webp)
...
![VfxEmitter entries listed inside a VFX container](/user-pictures/vector/general-guides/vfxdictionary/vfxemitter.webp)
...
![particleName string at the end of a VFX system](/user-pictures/vector/general-guides/vfxdictionary/particlename.webp)
...
![An emitterName field naming a vfxemitter](/user-pictures/vector/general-guides/vfxdictionary/emittername.webp)
...
![texture string pointing to a .dds texture file](/user-pictures/vector/general-guides/vfxdictionary/texture.webp)
### texturemult
...
![textureMult entry beneath a texture string](/user-pictures/vector/general-guides/vfxdictionary/texturemult.webp)
### scrollrate
...
![skinScale value inside a champion's skin bin](/user-pictures/vector/general-guides/vfxdictionary/skinscale.webp)
### materials
...
![Material definitions in a champion's skin bin](/user-pictures/vector/general-guides/vfxdictionary/materials.webp)
...
![birthColor RGBA values inside an emitter](/user-pictures/vector/general-guides/vfxdictionary/birthcolor.webp)
...
![Fresnel shader giving an object a highlighted rim](/user-pictures/vector/general-guides/vfxdictionary/fresnel.webp)
...
![Palette texture showing gradients used for particle coloring](/user-pictures/vector/general-guides/vfxdictionary/vfxpalletedefinitiondata.webp)

### rate
Determines the amount of particles that emit from the emitter.

![Adjusting the rate value on Evelynn's sparkle emitter](/user-pictures/vector/general-guides/vfxdictionary/rate.gif)
...
![Dynamics block listing RGBA values and times](/user-pictures/vector/general-guides/vfxdictionary/dynamics.webp)
...
![Black and white erosion map texture example](/user-pictures/vector/general-guides/vfxdictionary/erosion1.webp)
...
![Erosion effect constrained by a pink and yellow map](/user-pictures/vector/general-guides/vfxdictionary/erosion2.gif)
### normal map
...
![Normal map distortion effect behind a particle](/user-pictures/vector/general-guides/vfxdictionary/normalmap.webp)
### numframes: u16
