...
![Diagonal matrix values that control the particle size](./matrixstep1.webp)
...
```
##### Result
![In-game result of the enlarged particle effect](./matrix2.webp)

#### Moving/ Editing xyz values

![Bottom row matrix values that control the particle position](./matrix3.webp)
...
![In-game result of the repositioned particle effect](./matrix4.webp)
