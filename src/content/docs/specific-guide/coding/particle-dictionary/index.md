...
![A VfxSystemDefinitionData container in a bin file](./vfxsystemdefinitiondata.webp)
...
![VfxEmitter entries listed inside a VFX container](./vfxemitter.webp)
...
![particleName string at the end of a VFX system](./particlename.webp)
...
![An emitterName field naming a vfxemitter](./emittername.webp)
...
![texture string pointing to a .dds texture file](./texture.webp)
### texturemult
...
![textureMult entry beneath a texture string](./texturemult.webp)
### scrollrate
...
![skinScale value inside a champion's skin bin](./skinscale.webp)
### materials
...
![Material definitions in a champion's skin bin](./materials.webp)
...
![birthColor RGBA values inside an emitter](./birthcolor.webp)
...
![Fresnel shader giving an object a highlighted rim](./fresnel.webp)
...
![Palette texture showing gradients used for particle coloring](./vfxpalletedefinitiondata.webp)

### rate
Determines the amount of particles that emit from the emitter.

![Adjusting the rate value on Evelynn's sparkle emitter](./rate.gif)
...
![Dynamics block listing RGBA values and times](./dynamics.webp)
...
![Black and white erosion map texture example](./erosion1.webp)
...
![Erosion effect constrained by a pink and yellow map](./erosion2.gif)
### normal map
...
![Normal map distortion effect behind a particle](./normalmap.webp)
### numframes: u16
