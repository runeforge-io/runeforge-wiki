...
![Bin section that comes right before the paste location](./ptcl1.webp)
after that ^
...
and before this v
![Bin section that should come after the pasted container](./ptcl2.webp)

---

#### New Champion with VFX in skin0 bin

![The very last particle container in the skin0 bin](./ptcl3.webp)
...
![Renaming the VFX system to GravesRecall_VFX in quotes](./ptcl7.webp)
...
![ParticleName and ParticleString renamed to match the system name](./ptcl8.webp)
...
![ResourceResolver entry linking the new VFX system name](./ptcl9.webp)
...
![Searching the animation bin for the recall .anm file](./ptcl10.webp)
...
![mEventDataMap code pasted under the recall animation clip](./ptcl11.webp)
...
![Particle event data added to an existing mEventDataMap](./ptcl12.webp)
...
![Particle event with mStartFrame set to a later frame](./ptcl13.webp)
...
![Particle event using the mIsLoop and mIsKillEvent options](./ptcl14.webp)
...
![Ahri's hidden recall submeshes shown via animation events](./ptcl15.webp)

Here I’m adding a recall material for Katarina’s recall animation.

![Adding a recall material event for Katarina's recall animation](./ptcl16.webp)
## Sources
