...
![Diagonal matrix values that control the particle size](/user-pictures/vector/general-guides/matrixstep1.webp)
...
```
##### Result
![In-game result of the enlarged particle effect](/user-pictures/vector/general-guides/matrix2.webp)

#### Moving/ Editing xyz values

![Bottom row matrix values that control the particle position](/user-pictures/vector/general-guides/matrix3.webp)
...
![In-game result of the repositioned particle effect](/user-pictures/vector/general-guides/matrix4.webp)
