...
![Obsidian showing League's Champions folder contents](./sg1.webp)
...
![Selecting champion files and skin0.bin in Obsidian](./sg2.webp)
...
![Audacity with an imported voice line track](./sg3.webp)
...
![Splitting and trimming a sound clip in Audacity](./sg4.gif)
...
![Volume gauge under the track's Effects tab in Audacity](./sg5.webp)
...
![Setting Wwise default conversion settings to Vorbis Quality High](./sg6.gif)
...
![Importing audio folders into Wwise](./sg7.gif)
...
![BNK Extract GUI with its three select buttons](./sg8.webp)
...
![BNK Extract window with parsed SFX files](./sg9.webp)

The window should look something like this for **voice-over:**

![BNK Extract window with parsed voice-over files](./sg10.webp)
...
![cslol-tools folder inside the CSLoL Manager install location](./sg12.webp)
...
![Created wad file next to the parent folder](./sg13.webp)
...
![CSLoL Manager showing a conflict between two sound mods](./problem.png)
