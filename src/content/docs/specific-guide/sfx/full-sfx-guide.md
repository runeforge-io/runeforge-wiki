...
![Obsidian showing League's Champions folder contents](/user-pictures/vector/general-guides/sfxguide/sg1.webp)
...
![Selecting champion files and skin0.bin in Obsidian](/user-pictures/vector/general-guides/sfxguide/sg2.webp)
...
![Audacity with an imported voice line track](/user-pictures/vector/general-guides/sfxguide/sg3.webp)
...
![BNK Extract GUI with its three select buttons](/user-pictures/vector/general-guides/sfxguide/sg8.webp)
...
![BNK Extract window with parsed SFX files](/user-pictures/vector/general-guides/sfxguide/sg9.webp)

The window should look something like this for **voice-over:**

![BNK Extract window with parsed voice-over files](/user-pictures/vector/general-guides/sfxguide/sg10.webp)
...
![cslol-tools folder inside the CSLoL Manager install location](/user-pictures/vector/general-guides/sfxguide/sg12.webp)
...
![Created wad file next to the parent folder](/user-pictures/vector/general-guides/sfxguide/sg13.webp)
...
![CSLoL Manager showing a conflict between two sound mods](/user-pictures/wiko/problem.png)
