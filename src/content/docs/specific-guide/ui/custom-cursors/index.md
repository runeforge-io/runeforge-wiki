...
![Cursors folder selected in Obsidian for extraction](./assetsuxcursors.png)
...
![Extracted cursor files in the cursors folder](./cursors.png)
...
![Custom cursor pasted as a new layer in paint.net](./igot2layers.png)
...
![Background layer unchecked in the paint.net layers tab](./cursorsunckechkedlayers.png)

Process for other pointers is the same, the paint bucket tool is used to recolor the pointers accordingly.

![Pointers recolored red and blue with the paint bucket tool](./rednbluecursor.png)
...
![TGA save settings dialog in paint.net](./tgacompression.png)
...
![Flatten image prompt shown when saving the TGA](./flattenimage.png)
...
![Assets folder placed inside a UI.wad.client folder](./cursorspathwin.png)
