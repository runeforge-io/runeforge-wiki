...
tags:
  ...
  tool: [photoshop, paint-net, ritoddstex]
---
...
1. Open the template you have downloaded and go to Map11 folder and get srbackground.tex.
2. You will convert the srbackground file using [tex2dds](/core-guides/tools/ritoddstex).
3. Open the DDS file you got in the image editing program of choice.
4. Take the image you prepared and copy it over the background.
...
<Tabs>
  <TabItem label="Photoshop">
    ...
    If you aren't using Photoshop you can use [this online converter](https://www.convertidor.es/png-a-dds) or any other application that can save a DDS file.
