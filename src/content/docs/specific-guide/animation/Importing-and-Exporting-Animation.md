...
<img src="/user-pictures/goat/extracting_stuff.png" alt="Extracting the champion folder with Obsidian" height="400" />
...
<img src="/user-pictures/goat/importexport/import_options.png" alt="Required animation import options in Maya" height="600" />
...
<img src="/user-pictures/goat/cry_about_it.gif" alt="Blitzcrank's walk animation playing in the Maya viewport" height="300" />
...
<img src="/user-pictures/goat/timeline_show-off.png" alt="Selecting the export frame range in the Maya timeline" height="300" />
...
<img src="/user-pictures/goat/waving.gif" alt="Small waving demo animation between frames 40 and 60" height="325" />
This is not what you want
![Timeline with mismatched range numbers, which is wrong](/user-pictures/goat/timeline_specification.png)
This is what you want
![Timeline with matching range numbers and a full bar](/user-pictures/goat/timeline_specification2.png)
...
![Export All option in the File menu](/user-pictures/goat/export_all.png)

Then, select the animation you want to replace and make sure you export as [.anm](/specific-guide/filetypes)

<img src="/user-pictures/goat/export_has_anm.png" alt="Export dialog with the .anm file type selected" height="400" />

Annnnnd well done! You now know how to import and export animations for League models!

<img src="/user-pictures/goat/works.gif" alt="The exported custom animation playing in game" height="450" />
