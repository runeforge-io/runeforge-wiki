...
<img src="/user-pictures/goat/retargetanimation/1.png" alt="Importing the skn with the League of Legends SKN file type" height="400" />
...
<img src="/user-pictures/goat/retargetanimation/2.png" alt="ANM import settings with both overrides set to match source" height="500" />

Next select the "Root" bone and add a prefix. Go to Modify > Prefix Hierarchy Names

![Prefix Hierarchy Names option in the Modify menu](/user-pictures/goat/retargetanimation/3.png)

And put anything you want there (I'll put Ahri_ because it looks clean)

![Typing the Ahri_ prefix in the hierarchy names dialog](/user-pictures/goat/retargetanimation/4.png)
...
<img src="/user-pictures/goat/retargetanimation/5.png" alt="Importing the Targeted SKL's skn into the same scene" height="400" />
...
<img src="/user-pictures/goat/retargetanimation/8.png" alt="Both skeletons with their arms at matching angles" height="400" />
...
<img src="/user-pictures/goat/retargetanimation/6.png" alt="Main SKL mesh and skeleton grayed out in the Outliner" height="400" />

Click the little t-posing dude in the top right corner of maya, and then "Create Character Definition"

![Create Character Definition option under the t-pose icon](/user-pictures/goat/retargetanimation/7.png)
...
<img src="/user-pictures/goat/retargetanimation/9.png" alt="Bone icon above the viewport showing bones through the mesh" height="400" />
...
![Other bones grayed out after double clicking the shoulder](/user-pictures/goat/retargetanimation/10.png)
...
<img src="/user-pictures/goat/retargetanimation/11.png" alt="Clicking the matching left shoulder bone on the Targeted SKL" height="400" />

Both left arm and right arm should now turn green on the scary man, this means that the bone was assigned succesfully.

![Both arms turned green after a successful bone assignment](/user-pictures/goat/retargetanimation/12.png)
...
<img src="/user-pictures/goat/retargetanimation/19.png" alt="Completed character definition with all bones assigned green" height="600" />
...
![Hiding the Targeted SKL and unhiding the Main SKL](/user-pictures/goat/retargetanimation/20.png)

Now, above the scary man, you will find a little "+" icon, click it. This will create a new character definition.

![Plus icon that creates a new character definition](/user-pictures/goat/retargetanimation/21.png)
...
<img src="/user-pictures/goat/retargetanimation/24.png" alt="Assigning the extra spine bones in the spine menu" height="500" />

Once that is done go back above the scary man menu and put "Character 1" in "Characters" and "Character 2" in "Source".

![Setting Character 1 as Character and Character 2 as Source](/user-pictures/goat/retargetanimation/25.png)

And now see the magic unfold!

![Ornn's skeleton playing Ahri's retargeted dance animation](/user-pictures/goat/retargetanimation/magic.gif)
...
![Bake to Skeleton option under the blue square menu](/user-pictures/goat/retargetanimation/26.png)
...
![Finished retargeted dance animation playing on the model](/user-pictures/goat/retargetanimation/magicwin.gif)
