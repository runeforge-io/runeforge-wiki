...
<img src="/user-pictures/nyht/gif-ezgif.com-crop.gif" alt="Base Gragas animations overriding Hillbilly Gragas's animations" height="200" />
...
![The lolAnimPath animation repathing tool interface](/user-pictures/nyht/image_2025-03-09_160551448.png)
...
![New custom animation folder inside the Gragas base skin folder](/user-pictures/nyht/image_2024-11-14_030547323.png)
...
<img src="/user-pictures/nyht/image_2024-11-14_031804514.png" alt="Skin0.bin renamed to a unique name in the animations folder" height="100" />
...
![The linked list of strings entry in Skin0.bin](/user-pictures/nyht/image_2024-11-14_033218583.png)
and `animationGraphData: link = ""`.

![The animationGraphData link entry in Skin0.bin](/user-pictures/nyht/image_2024-11-14_033336722.png)
...
![Linked path updated to point at the custom animation folder](/user-pictures/nyht/image_2024-11-14_033612231.png)

![animationGraphData path updated to the custom animation bin](/user-pictures/nyht/image_2024-11-14_033807720.png)
...
#### Original
![Original animation path in the animations folder Skin0.bin](/user-pictures/nyht/image_2024-11-14_034252811.png)

#### Edited
![Edited animation path in the animations folder Skin0.bin](/user-pictures/nyht/image_2024-11-14_034438953.png)
...
![Repathed animation references inside the AtomicClipData sections](/user-pictures/nyht/image_2024-11-14_040854007.png)

### Result
<img src="/user-pictures/nyht/2024-11-1403-48-27-ezgif.com-resize.gif" alt="Custom animations now applying only to the intended skin" height="300" />
