...
![Scuttle crab moonwalking, facing away from its movement direction](./skuttle_moonwalk.gif)

## How to fix
1. Convert and open the SkinX.bin of your skin, for example Skin0.bin
2. Delete the `rigPoseModifierData` block:
   ![The rigPoseModifierData block to delete in the converted bin file](./moonwalk_fix.png)
