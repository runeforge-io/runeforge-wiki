...
![LtMAO context menu converting DDS files to TEX](./ddstexdel.png)

### 3. Repack Your WAD and Reload CSLOL

![Repacking the extracted folder back into a WAD file](./backtowad.png)
![Deleting the leftover extracted WAD folder](./deletefolder.png)

This should be it. If you did everything right, your textures should look normal again in game.

![Fixed skin textures displaying correctly in game](./brad.png)
...
![Extracting the mod](./extract_-_open.png)
...
<video width="720" height="auto" controls>
  <source src="/guide-media/broken-textures/how_to_add_a_folder_to_path_on_windows.mp4" type="video/mp4" />
</video>
...
![Opening a command prompt from the explorer address bar](./open_cmd_here.gif)
...
![Error converting a DDS with an unsupported pixel format](./saved_bad_dds.png)
...
![texconv command converting all DDS files to BC3_UNORM](./img_of_texconv_cmd.png)
...
![texdiag info output showing a DDS file's details](./texdiag_out.png)
...
![Comparison showing resampling artifacts after resizing a small icon](./fukt_up_resize.png)
...
![Filtered list of unique texture dimensions in Notepad++](./npp_sizes.png)
