...
![Example of a broken healthbar in game](/user-pictures/fbs/hpbarexample1.png)
![Another example of a broken healthbar in game](/user-pictures/fbs/hpbarexample.png)
...
![Extracting the wad.client file with LtMAO's context menu](/user-pictures/fbs/extract-wad.png)
...
![Converting the skin bin files to py with LtMAO](/user-pictures/fbs/convertbintopy.png)

In your text editor press `Ctrl+F` and search for `unitHealthBarStyle`, it will look something like this:

![The unitHealthBarStyle value found in the py file](/user-pictures/fbs/hpbarstyle9.png)
...
![Excited kitty meme celebrating the fixed healthbar](/user-pictures/fbs/excited-kitty.png)
