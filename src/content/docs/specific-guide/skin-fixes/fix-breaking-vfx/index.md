...
![Broken particles appearing as blocky shapes in game](./showbrokenvfx.webp)
...
![Default Soraka particles with broken transparency](./transparent1.webp) ![Edited Lux particles with broken transparency](./transparent2.webp)
...
![Black background texture rendered with blendmode 4](./transparent3.webp)
*Black background texture, BLENDMODE 4*

![Black background texture rendered with blendmode 1](./transparent4.webp)
...
![The blendmode value inside an emitter near birthColor](./transparent5.webp)
