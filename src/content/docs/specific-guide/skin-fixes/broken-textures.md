...
<img src="/user-pictures/fbs/wrongred.png" alt="Mod's WAD file inside CSLOL's installed folder" height="260" />
...
<img src="/user-pictures/fbs/ddstexdel.png" alt="LtMAO context menu converting DDS files to TEX" height="105" />

### 3. Repack Your WAD and Reload CSLOL

<img src="/user-pictures/fbs/backtowad.png" alt="Repacking the extracted folder back into a WAD file" height="120" />
<img src="/user-pictures/fbs/deletefolder.png" alt="Deleting the leftover extracted WAD folder" height="55" />

This should be it. If you did everything right, your textures should look normal again in game.

<img src="/user-pictures/fbs/brad.png" alt="Fixed skin textures displaying correctly in game" height="300" />
...
<img src="/user-pictures/moga/extract_&_open.png" alt="Extracting the mod's Fantome file with 7-Zip" height="250" />
...
> - All champions use TEX files for their textures and particles.
> - Most files found under `assets\shared` do not need to be TEX and should be left alone if they are. (15.16 the majority of these will also become tex.)
...
<img src="/user-pictures/moga/saved_bad_dds.png" alt="Error converting a DDS with an unsupported pixel format" height="200" />
...
![texconv command converting all DDS files to BC3_UNORM](/user-pictures/moga/img_of_texconv_cmd.png)
...
![texdiag info output showing a DDS file's details](/user-pictures/moga/texdiag_out.png)
...
<img src="/user-pictures/moga/fukt_up_resize.png" alt="Comparison showing resampling artifacts after resizing a small icon" height="220" />
...
![Filtered list of unique texture dimensions in Notepad++](/user-pictures/moga/npp_sizes.png)
