...
<Tabs>
  <TabItem label="Loading screen borders">
...
<Tabs>
  ...
  <TabItem label="Loadingscreen assets">
    Splash art, in-game circle and square templates that have the shadow border made as close to the one that Riot skins have.[^6]
