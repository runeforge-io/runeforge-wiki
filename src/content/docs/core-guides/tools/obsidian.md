...
![GitHub releases page with the latest Obsidian release marked](/user-pictures/vector/general-guides/general/obsidian/obsidian_download_marked.png)
...
![Obsidian first-start prompt asking for the League Game folder](/user-pictures/vector/general-guides/general/obsidian/obsidian_firststart.png)
...
![Obsidian file tree with DATA and FINAL folders opened](/user-pictures/vector/general-guides/general/obsidian/obsidian_usage01.png)
...
![File menu showing the Extract Selected option](/user-pictures/vector/new-post-guide/extract.webp)

![Choosing an export folder for the extracted files](/user-pictures/vector/general-guides/general/obsidian/obsidian_usage02.png)
