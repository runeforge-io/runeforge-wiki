...
![No skin cluster found error message in Maya](/user-pictures/bud/no_skin_cluster.png)
...
![Error about vertices weighted to more than 4 influences](/user-pictures/bud/4_influences.png)
...
![Too many vertices found error message in Maya](/user-pictures/bud/too_many_verts.png)
...
![Error about vertices shared by multiple materials](/user-pictures/bud/multiplemats.png)
