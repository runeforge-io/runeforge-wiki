...
![Ritobin GitHub releases page showing the latest release](./ritogit.webp)
...
![Ritobin file dialog for selecting a saved bin file](./ritofile.webp)
...
![Dragging the modified py file onto the Ritobin cli application](./convert_to__bin.webp)
