...
![GitHub releases page with the latest Obsidian release marked](./obsidian_download_marked.png)
...
![Obsidian first-start prompt asking for the League Game folder](./obsidian_firststart.png)
...
![Obsidian file tree with DATA and FINAL folders opened](./obsidian_usage01.png)
...
![File menu showing the Extract Selected option](./extract.webp)

![Choosing an export folder for the extracted files](./obsidian_usage02.png)
