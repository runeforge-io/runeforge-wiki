...
![cs-lol download](./csloldownload.png)
...
![CS-LoL mod list with a skin selected and Run button](./running_skins.webp)
...
![CS-LoL folder keeping only subfolders and the Config file](./update_cslol.webp)
...
![Extraction popup asking to confirm overwriting existing files](./untitled-1.png)
...
<video width="640" height="auto" controls>
  <source src="/guide-media/cslolmanager/cslolmakemod_fiels.mp4" type="video/mp4" />
</video>

![Mod folder structure matching the original wad file layout](./folder_structure.png)
...
<video width="480" height="auto" controls>
  <source src="/guide-media/cslolmanager/cslolmakemod_create.mp4" type="video/mp4" />
</video>
...
![Renaming a mod through the edit option in the list](./edit_mod_list.webp)
...
![Settings with the Suppress Install Conflicts option enabled](./conflicting_mods.webp)
