...
![Nvidia Texture Tools exporter settings for saving dds files](./nvidia_txt_showcase.png)
...
#### Download
- [DDS Plugin Download](/downloads/dds.8bi)
...
![Simple DDS plugin save options with DXT5 format selected](./ddsplg.png)
