...
![Ritobin GitHub releases page showing the latest release](/user-pictures/vector/new-post-guide/ritogit.webp)
...
![Ritobin file dialog for selecting a saved bin file](/user-pictures/vector/new-post-guide/ritofile.webp)
...
![Dragging the modified py file onto the Ritobin cli application](/user-pictures/vector/new-post-guide/convert_to__bin.webp)
