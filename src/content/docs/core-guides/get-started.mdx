...
tags:
  type: overview
  level: beginner
  subject: [getting-started, installation]
  tool: [cslol-manager, obsidian]
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

<img src="/titles/beginners.webp" alt="Get Started beginners guide title banner" style="width:50%" />
...
<Tabs>
  ...
  <TabItem label="Editing Software">
